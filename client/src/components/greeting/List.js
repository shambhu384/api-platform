...
import { success } from '../../actions/greeting/delete';
...
const mapStateToProps = (state) => {
  return {
    data: state.greeting.list.data,
    error: state.greeting.list.error,
    loading: state.greeting.list.loading,
    deletedItem: state.greeting.del.deleted,
  };
};
